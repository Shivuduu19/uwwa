...
export default function Home() {
  ...
  const getstrtedva = useTransform(getstarteddiv.scrollYProgress, [0, 1], [100, 94])
  ...
  return (
    <>
      <main >
        ...
        <section className=" py-[100px] pb-0 px-[5%] relative">
          <div className="w-full mx-auto relative">
            <div className="flex items-start flex-wrap justify-between ">
              <div className="w-layout-hflex  flex-1 items-stretch flex-wrap !flex-col  justify-between">
                <div className="flex-none self-start opacity-80">
                  <h1 className="uppercase text-[.75rem] font-normal leading-[2]">/ Studio /</h1>
                </div>
                <div className="max-w-[384px] self-start">
                  <h2 className="text-[40px] my-0 font-semibold leading-[1.2]">Leading SaaS design innovators</h2>
                </div>
              </div>
              <div className="w-layout-hflex items-stretch flex-1 justify-end">
                <div className="max-w-[528px]">
                  <div className="flex flex-col gap-[2rem] items-start ">
                    <p className="opacity-60 mb-0 leading-[1.88] mt-0 ">
                    ...
                    <div className="w-layout-hflex ">
                      <p className="leading-[1.6] bg-[#2626251a] rounded-[999px] max-w-[262px] py-[.5em] px-[1.7em] text-[.875rem]">We will answer any design-related questions on a short call.</p>
                      <motion.a whileHover='hover' href="" className='bg-[#262625] text-white flex justify-center items-center text-center flex-none gap-[.71em] rounded-[99px] whitespace-nowrap py-[1.57em] px-[1.43em] text-[.875rem] font-semibold leading-[1] transition-all duration-[.2s] relative overflow-hidden max-w-full'>
                        ...
                        <motion.div variants={letsconect} className='relative'>Let's connect</motion.div>
                      </motion.a>
                    </div>
        ...
        <Testimonials />
        <div className="text-[#f3f3f1] flex items-center justify-center min-h-screen xl:px-[64px] py-[100px] relative ">
          ...
          <div ref={getstarted} className="max-w-[1230px] flex-1 w-full mx-auto relative flex items-start ">
            <div className="grid  grid-cols-[minmax(101px,1fr)_auto] gap-x-[8vw] justify-between w-full mt-auto grid-rows-[auto] auto-cols-[1fr] ">
              <div>
                <div className="opacity-80 ">
                  <h1 className="uppercase object-fill text-[12px] font-normal leading-[2]">/ Get started /</h1>
                </div>
              </div>
              <div className="flex flex-col gap-[70px] items-stretch row-span-1 col-span-1">
                <div className="xl:mb-[19vw] mb-[18vw]">
                  <h2 className="inline text-[8vw] leading-[1] font-semibold my-0 ">Let's Launch Your Journey</h2>
                  <figure className="inline relative ">
                    <div className="xl:top-[20.1vw] w-[50%] mt-[-18vw] inline-block relative overflow-hidden object-contain h-auto ">
                      <div className="flex justify-center items-center relative ">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 330" width="500" height="330" preserveAspectRatio="xMidYMid meet" style={{ width: "100%", height: "100%", transform: "translate3d(0px, 0px, 0px)", contentVisibility: "visible" }}>
                ...
                <div className="flex items-start gap-[30px] justify-between">
                  <div className="flex flex-col flex-1 items-stretch gap-[4rem] max-w-[416px] mb-0">
                    <p className="opacity-60"><strong>We are providing consultations, for free. Get &nbsp;advice on customer activation, onboarding design, reducing product complexity, or growth experiments.</strong></p>
                    <div className="w-layout-vflex gap-[6px]"><div className="opacity-40"><h5 class="uppercase object-fill text-[12px] font-normal leading-[2] my-0">Contact Us</h5>
                    </div>
                      <a href="mailto:hello@uwwa.co" className=" opacity-80">hello@uwwa.co</a><a href="tel:+48571044670" className=" opacity-80">+48 571 044 670</a></div>
                  </div>
        ...
        <div className="w-full mx-auto relative">
          <div className="grid auto-cols-[1fr] gap-x-[90px] gap-col-[100px] grid-rows-[auto] grid-cols-[minmax(max-content,auto)_max-content_max-content_minmax(auto,130px)]">
            ...
            <div className="justify-end">
              <a href="#header" aria-label="to-the-top" id="w-node-_257721c6-3ed8-277f-dbb1-60931b0806e4-f02c5440" data-w-id="257721c6-3ed8-277f-dbb1-60931b0806e4" className="cursor-none cursor-pointer w-inline-block">
